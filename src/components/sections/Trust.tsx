    ...
    <section className="py-8 md:py-32 bg-[#0D0630] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="text-center mb-5 md:mb-16">
          <p className="text-[#0D0630] font-bold text-xs md:text-sm uppercase tracking-wider mb-2 md:mb-3 bg-[#BEF221] inline-block px-3 md:px-4 py-1 md:py-1.5 rounded-full">
            {tr.badge}
          </p>
