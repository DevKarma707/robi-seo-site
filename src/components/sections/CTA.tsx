  ...
  return (
    <section className="py-14 md:py-32 bg-[#0D0630] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        <h2 className="text-xl md:text-2xl lg:text-3xl font-black text-white mb-4 md:mb-6 tracking-tight">
          <StyledRobiTitle text={title} />
        </h2>
        <p className="text-sm md:text-xl text-white/70 mb-8 md:mb-12">{subtitle}</p>
