...
export const industries: Industry[] = [
  // ==================== MÉTIERS DU BTP ====================
  {
    ...
    category: "btp",
    title: { fr: "Logiciel de Facturation pour Plombiers", en: "Invoicing Software for Plumbers", es: "Software de Facturación para Fontaneros" },
  ...
  },
  {
    ...
    category: "btp",
    title: { fr: "Logiciel de Facturation pour Électriciens", en: "Invoicing Software for Electricians", es: "Software de Facturación para Electricistas" },
  ...
  {
    slug: "macon",
    name: { fr: "Maçons", en: "Masons", es: "Albañiles", "pt-BR": "Pedreiros" },
    category: "btp",
    title: { fr: "Logiciel de Facturation pour Maçons", en: "Invoicing Software for Masons", es: "Software de Facturación para Albañiles", "pt-BR": "Software de Faturamento para Pedreiros" },
    description: { fr: "Facturez vos chantiers de maçonnerie facilement.", en: "Invoice your masonry projects easily.", es: "Factura tus proyectos de albañilería fácilmente.", "pt-BR": "Fature suas obras de alvenaria facilmente com Robi." },
    keywords: ["faturamento pedreiro", "orçamento obra brasil"],
    heroTitle: { fr: "Gérez vos chantiers de maçonnerie sans paperasse", en: "Manage your masonry projects without paperwork", es: "Gestiona tus proyectos de albañilería sin papeleo", "pt-BR": "Gerencie suas obras sem papelada" },
    painPoints: [
      { fr: "Chantiers multiples à gérer", en: "Multiple sites to manage", es: "Múltiples obras que gestionar", "pt-BR": "Gestão de múltiplas obras" },
      { fr: "Calcul des matériaux", en: "Material calculations", es: "Cálculo de materiales", "pt-BR": "Cálculo de materiais" },
      { fr: "Acomptes et situations", en: "Deposits and progress billing", es: "Anticipos y certificaciones", "pt-BR": "Adiantamentos e medições" },
    ],
    features: [
      { fr: "Devis par lots", en: "Batch quotes", es: "Presupuestos por lotes", "pt-BR": "Orçamentos por lotes" },
      { fr: "Calcul matériaux", en: "Material calculation", es: "Cálculo de materiales", "pt-BR": "Calculadora de materiais" },
      { fr: "Situations de travaux", en: "Progress billing", es: "Certificaciones de obra", "pt-BR": "Medição de serviços" },
    ],
  },
  {
    slug: "peintre",
    ...
    category: "btp",
    title: { fr: "Logiciel de Facturation pour Peintres", en: "Invoicing Software for Painters", es: "Software de Facturación para Pintores" },
  ...
  },
  {
    ...
    category: "btp",
    title: { fr: "Logiciel de Facturation pour Menuisiers", en: "Invoicing Software for Carpenters", es: "Software de Facturación para Carpinteros" },
  ...
  },
  {
    ...
    category: "btp",
    title: { fr: "Logiciel de Facturation pour Chauffagistes", en: "Invoicing Software for Heating Engineers", es: "Software de Facturación para Calefactores" },
  ...
  },
  {
    ...
    category: "btp",
    title: { fr: "Logiciel de Facturation pour Serruriers", en: "Invoicing Software for Locksmiths", es: "Software de Facturación para Cerrajeros" },
  ...
  },
  {
    ...
    category: "btp",
    title: { fr: "Logiciel de Facturation pour Carreleurs", en: "Invoicing Software for Tilers", es: "Software de Facturación para Alicatadores" },
  ...
  },
  {
    ...
    category: "btp",
    title: { fr: "Logiciel de Facturation pour Couvreurs", en: "Invoicing Software for Roofers", es: "Software de Facturación para Techadores" },
  ...
  },
  {
    ...
    category: "btp",
    title: { fr: "Logiciel de Facturation pour Architectes", en: "Invoicing Software for Architects", es: "Software de Facturación para Arquitectos" },
  ...
  // ==================== TECH & DIGITAL ====================
  {
    ...
    category: "tech",
    title: { fr: "Logiciel de Facturation pour Développeurs", en: "Invoicing Software for Developers", es: "Software de Facturación para Desarrolladores", "pt-BR": "Software de Faturamento para Desenvolvedores" },
  ...
  },
  {
    ...
    category: "tech",
    title: { fr: "Logiciel de Facturation pour Designers UX/UI", en: "Invoicing Software for UX/UI Designers", es: "Software de Facturación para Diseñadores UX/UI" },
  ...
  },
  {
    ...
    category: "tech",
    title: { fr: "Logiciel de Facturation pour Data Scientists", en: "Invoicing Software for Data Scientists", es: "Software de Facturación para Data Scientists" },
  ...
  },
  {
    ...
    category: "tech",
    title: { fr: "Logiciel de Facturation pour DevOps", en: "Invoicing Software for DevOps", es: "Software de Facturación para DevOps" },
  ...
  },
  {
    ...
    category: "tech",
    title: { fr: "Logiciel de Facturation pour Product Managers", en: "Invoicing Software for Product Managers", es: "Software de Facturación para Product Managers" },
  ...
  // ==================== CRÉATIFS ====================
  {
    ...
    category: "creatif",
    title: { fr: "Logiciel de Facturation pour Graphistes", en: "Invoicing Software for Graphic Designers", es: "Software de Facturación para Diseñadores Gráficos" },
  ...
  },
  {
    ...
    category: "creatif",
    title: { fr: "Logiciel de Facturation pour Photographes", en: "Invoicing Software for Photographers", es: "Software de Facturación para Fotógrafos" },
  ...
  },
  {
    ...
    category: "creatif",
    title: { fr: "Logiciel de Facturation pour Vidéastes", en: "Invoicing Software for Videographers", es: "Software de Facturación para Videógrafos" },
  ...
  },
  {
    ...
    category: "creatif",
    title: { fr: "Logiciel de Facturation pour Illustrateurs", en: "Invoicing Software for Illustrators", es: "Software de Facturación para Ilustradores" },
  ...
  },
  {
    ...
    category: "creatif",
    title: { fr: "Logiciel de Facturation pour Rédacteurs Web", en: "Invoicing Software for Web Writers", es: "Software de Facturación para Redactores Web" },
  ...
  },
  {
    ...
    category: "creatif",
    title: { fr: "Logiciel de Facturation pour Community Managers", en: "Invoicing Software for Community Managers", es: "Software de Facturación para Community Managers" },
  ...
  // ==================== ÉVÉNEMENTIEL ====================
  {
    ...
    title: { fr: "Logiciel de Facturation pour Traiteurs", en: "Invoicing Software for Caterers", es: "Software de Facturación para Catering" },
  ...
  },
  {
    ...
    category: "evenementiel",
    title: { fr: "Logiciel de Facturation pour DJs", en: "Invoicing Software for DJs", es: "Software de Facturación para DJs" },
  ...
  },
  {
    ...
    category: "evenementiel",
    title: { fr: "Logiciel de Facturation pour Wedding Planners", en: "Invoicing Software for Wedding Planners", es: "Software de Facturación para Wedding Planners" },
  ...
  },
  {
    ...
    category: "evenementiel",
    title: { fr: "Logiciel de Facturation pour Décorateurs", en: "Invoicing Software for Event Decorators", es: "Software de Facturación para Decoradores de Eventos" },
  ...
  },
  {
    ...
    category: "evenementiel",
    title: { fr: "Logiciel de Facturation pour Photographes de Mariage", en: "Invoicing Software for Wedding Photographers", es: "Software de Facturación para Fotógrafos de Bodas" },
  ...
  // ==================== CONSEIL & SERVICES ====================
  {
    ...
    category: "conseil",
    title: { fr: "Logiciel de Facturation pour Consultants", en: "Invoicing Software for Consultants", es: "Software de Facturación para Consultores" },
  ...
  },
  {
    ...
    category: "conseil",
    title: { fr: "Logiciel de Facturation pour Coachs", en: "Invoicing Software for Coaches", es: "Software de Facturación para Coaches" },
  ...
  },
  {
    ...
    category: "conseil",
    title: { fr: "Logiciel de Facturation pour Avocats", en: "Invoicing Software for Lawyers", es: "Software de Facturación para Abogados" },
  ...
  },
  {
    ...
    category: "conseil",
    title: { fr: "Logiciel de Facturation pour Agents Immobiliers", en: "Invoicing Software for Real Estate Agents", es: "Software de Facturación para Agentes Inmobiliarios" },
  ...
  },
  {
    ...
    category: "conseil",
    title: { fr: "Logiciel de Facturation pour Experts-Comptables", en: "Invoicing Software for Accountants", es: "Software de Facturación para Contables" },
  ...
  },
  {
    ...
    category: "conseil",
    title: { fr: "Logiciel de Facturation pour Traducteurs", en: "Invoicing Software for Translators", es: "Software de Facturación para Traductores" },
  ...
  // ==================== SANTÉ & BIEN-ÊTRE ====================
  {
    ...
    category: "sante",
    title: { fr: "Logiciel de Facturation pour Kinésithérapeutes", en: "Invoicing Software for Physiotherapists", es: "Software de Facturación para Fisioterapeutas" },
  ...
  },
  {
    ...
    category: "sante",
    title: { fr: "Logiciel de Facturation pour Ostéopathes", en: "Invoicing Software for Osteopaths", es: "Software de Facturación para Osteópatas" },
  ...
  },
  {
    ...
    category: "sante",
    title: { fr: "Logiciel de Facturation pour Psychologues", en: "Invoicing Software for Psychologists", es: "Software de Facturación para Psicólogos" },
  ...
  },
  {
    ...
    category: "sante",
    title: { fr: "Logiciel de Facturation pour Diététiciens", en: "Invoicing Software for Dietitians", es: "Software de Facturación para Dietistas" },
  ...
  },
  {
    ...
    category: "sante",
    title: { fr: "Logiciel de Facturation pour Sophrologues", en: "Invoicing Software for Sophrologists", es: "Software de Facturación para Sofrólogos" },
  ...
  },
  {
    ...
    category: "sante",
    title: { fr: "Logiciel de Facturation pour Naturopathes", en: "Invoicing Software for Naturopaths", es: "Software de Facturación para Naturópatas" },
...
export const features = [
  { slug: "facturation-ia", name: { fr: "Facturation par IA", en: "AI Invoicing", es: "Facturación con IA" }, title: { fr: "Facturation par Intelligence Artificielle", en: "AI-Powered Invoicing", es: "Facturación con Inteligencia Artificial" }, description: { fr: "Créez des factures en parlant.", en: "Create invoices by speaking.", es: "Crea facturas hablando." }, keywords: ["facturation ia", "facture intelligence artificielle"] },
  { slug: "devis-automatique", name: { fr: "Devis Automatiques", en: "Automatic Quotes", es: "Presupuestos Automáticos" }, title: { fr: "Générateur de Devis Automatique", en: "Automatic Quote Generator", es: "Generador de Presupuestos Automático" }, description: { fr: "Générez des devis professionnels en quelques secondes.", en: "Generate professional quotes in seconds.", es: "Genera presupuestos profesionales en segundos." }, keywords: ["devis automatique", "générateur devis"] },
  { slug: "relance-automatique", name: { fr: "Relances Automatiques", en: "Automatic Reminders", es: "Recordatorios Automáticos" }, title: { fr: "Relances de Factures Automatiques", en: "Automatic Invoice Reminders", es: "Recordatorios de Facturas Automáticos" }, description: { fr: "Fini les impayés. Robi relance vos clients automatiquement.", en: "No more unpaid invoices. Robi follows up automatically.", es: "Se acabaron los impagos. Robi hace seguimiento automáticamente." }, keywords: ["relance facture", "relance automatique"] },
  { slug: "paiement-en-ligne", name: { fr: "Paiement en Ligne", en: "Online Payments", es: "Pagos Online" }, title: { fr: "Paiement en Ligne Stripe & PayPal", en: "Online Payments Stripe & PayPal", es: "Pagos Online Stripe & PayPal" }, description: { fr: "Soyez payé 2x plus vite avec les liens de paiement intégrés.", en: "Get paid 2x faster with integrated payment links.", es: "Cobra 2 veces más rápido con links de pago integrados." }, keywords: ["paiement en ligne facture", "stripe facturation"] },
  { slug: "tableau-de-bord", name: { fr: "Tableau de Bord", en: "Dashboard", es: "Panel de Control" }, title: { fr: "Tableau de Bord Freelance", en: "Freelance Dashboard", es: "Panel de Control Freelance" }, description: { fr: "Visualisez votre CA en un coup d'œil.", en: "Visualize your revenue at a glance.", es: "Visualiza tu facturación de un vistazo." }, keywords: ["tableau de bord freelance", "dashboard facturation"] },
];
...
export const blogPosts = [
  {
    ...
    title: { fr: "Comment Facturer Son Premier Client : Guide Complet 2026", en: "How to Invoice Your First Client: Complete Guide 2026", es: "Cómo Facturar a Tu Primer Cliente: Guía Completa 2026", "pt-BR": "Como Faturar Seu Primeiro Cliente: Guia Completo 2026" },
  ...
  },
  {
    ...
    title: { fr: "TJM Freelance 2026 : Quel Tarif Journalier Moyen ?", en: "Freelance Day Rate 2026: What's the Average?", es: "Tarifa Diaria Freelance 2026: ¿Cuál es la Media?", "pt-BR": "Diária Freelance 2026: Qual é a Média Ideal?" },
    description: { fr: "Découvrez les TJM par métier et région en 2026 pour fixer votre tarif au juste prix et booster vos revenus.", en: "Discover 2026 day rates by profession and region to set the right price and boost your income.", es: "Descubre las tarifas diarias 2026 por profesión y región para fijar el precio correcto.", "pt-BR": "Descubra os valores de diárias por profissão e região em 2026 para definir o preço certo e aumentar sua receita." },
    keywords: ["tjm freelance", "tarif journalier moyen 2026", "salaire freelance"],
    category: "business",
    date: "2025-01-15",
  ...
  },
  {
    ...
    title: { fr: "Micro-Entreprise vs SASU : Quel Statut Choisir en 2026 ?", en: "Sole Trader vs LLC: Which Status to Choose in 2026?", es: "Autónomo vs Sociedad: ¿Qué Estatus Elegir en 2026?", "pt-BR": "MEI vs Empresa Simples: Qual Status Escolher em 2026?" },
    ...
    keywords: ["micro entreprise vs sasu", "statut juridique freelance", "auto entrepreneur 2026"],
    category: "legal",
    date: "2025-01-03",
...
// ===== TOOLS =====
export const tools = [
  { slug: "generateur-facture", name: { fr: "Générateur de Facture", en: "Invoice Generator", es: "Generador de Facturas" }, title: { fr: "Générateur de Facture Gratuit en Ligne", en: "Free Online Invoice Generator", es: "Generador de Facturas Gratis Online" }, description: { fr: "Créez et téléchargez une facture conforme en PDF, gratuitement et sans inscription.", en: "Create and download a compliant PDF invoice, free and without signing up.", es: "Crea y descarga una factura conforme en PDF, gratis y sin registro." }, keywords: ["générateur de facture", "créer une facture en ligne", "facture pdf gratuit", "modèle de facture"] },
  { slug: "calculateur-tjm", name: { fr: "Calculateur de TJM", en: "Day Rate Calculator", es: "Calculadora de Tarifa Diaria" }, title: { fr: "Calculateur de Tarif Journalier Moyen Gratuit", en: "Free Day Rate Calculator", es: "Calculadora de Tarifa Diaria Gratis" }, description: { fr: "Calculez votre TJM idéal.", en: "Calculate your ideal day rate.", es: "Calcula tu tarifa diaria ideal." }, keywords: ["calculateur tjm"] },
  { slug: "simulateur-charges", name: { fr: "Simulateur de Charges", en: "Tax Simulator", es: "Simulador de Impuestos" }, title: { fr: "Simulateur de Charges Freelance Gratuit", en: "Free Freelance Tax Simulator", es: "Simulador de Impuestos Freelance Gratis" }, description: { fr: "Estimez vos charges sociales et fiscales.", en: "Estimate your social and tax charges.", es: "Estima tus cargas sociales y fiscales." }, keywords: ["simulateur charges freelance"] },
  { slug: "generateur-mentions-legales", name: { fr: "Générateur de Mentions Légales", en: "Legal Notice Generator", es: "Generador de Aviso Legal" }, title: { fr: "Générateur de Mentions Légales Gratuit", en: "Free Legal Notice Generator", es: "Generador de Aviso Legal Gratis" }, description: { fr: "Créez vos mentions légales conformes RGPD.", en: "Create your GDPR compliant legal notices.", es: "Crea tus avisos legales conformes con RGPD." }, keywords: ["générateur mentions légales"] },
];
