            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Card className="p-6 text-center">
                  ...
                  <p className="text-sm text-white/50">{dict.billableDays || "Jours facturables/an"}</p>
                </Card>
                <Card className="p-6 text-center">
                  ...
                  <p className="text-sm text-white/50">{dict.requiredRevenue || "CA nécessaire/an"}</p>
                </Card>
                <Card className="p-6 text-center">
                  ...
                  <p className="text-sm text-white/50">{dict.weeklyRevenue || "CA/semaine"}</p>
                </Card>
                <Card className="p-6 text-center">
                  ...
                  <p className="text-sm text-white/50">{dict.monthlyRevenue || "CA/mois"}</p>
                </Card>
              </div>
              ...
              <Button href={`/${locale}/signup`} className="w-full" size="lg">
