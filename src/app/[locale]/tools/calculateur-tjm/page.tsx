...
export default function CalculateurTJMPage() {
  ...
  // Calculs
  const joursOuvrables = 365 - 104 - 11; // Weekends + jours fériés
  ...
  return (
    <>
      <Hero
        ...
        subtitle="Calculez votre Tarif Journalier Moyen idéal en fonction de vos objectifs et charges."
        variant="centered"
      />
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#BEF221] focus:border-transparent"
                  >
                    <option value={22}>Micro-entreprise (22%)</option>
                    <option value={25}>Micro-entreprise BNC (25%)</option>
                    <option value={45}>SASU/EURL (45%)</option>
                    <option value={50}>SASU avec dividendes (50%)</option>
                  </select>
                </div>
              </div>
            </Card>
            ...
            <div className="space-y-6">
              <Card variant="dark" className="p-8">
                <h2 className="text-xl font-bold text-white mb-6">
                  Votre TJM recommandé
                </h2>
                <div className="text-6xl font-black text-[#BEF221] mb-4">
                  {tjmCalcule}€
                  <span className="text-xl text-white/50">/jour</span>
                </div>
                <p className="text-white/70">
                  Pour atteindre votre objectif de {salaireSouhaite.toLocaleString()}€ net/an
                </p>
              </Card>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Card className="p-6 text-center">
                  ...
                  <p className="text-sm text-gray-500">Jours facturables/an</p>
                </Card>
                <Card className="p-6 text-center">
                  ...
                  <p className="text-sm text-gray-500">CA nécessaire/an</p>
                </Card>
                <Card className="p-6 text-center">
              ...
              <Card className="p-6 bg-[#BEF221]/10 border-[#BEF221]/30">
                <h3 className="font-bold text-[#0D0630] mb-2">
                  💡 Conseil Robi
                </h3>
                <p className="text-sm text-gray-700">
                  N'oubliez pas d'ajouter une marge de 10-15% pour les imprévus et
                  l'épargne. Un TJM de <strong>{Math.round(tjmCalcule * 1.1)}€</strong> serait plus sécurisant.
                </p>
              </Card>
      ...
      <CTA
        title="Gérez vos factures comme un pro"
        subtitle="Robi calcule vos totaux, génère vos factures et relance vos clients"
      />
    </>
  );
}
